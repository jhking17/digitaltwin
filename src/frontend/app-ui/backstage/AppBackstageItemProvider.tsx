    ...
    if (!this._backstageItems) {
      this._backstageItems = [
        BackstageItemUtilities.createStageLauncher("SampleFrontstage", 100, 10,
          IModelApp.i18n.translateWithNamespace("en","NineZoneSample:backstage.sampleFrontstage"), undefined, "icon-placeholder"),
        BackstageItemUtilities.createStageLauncher("SampleFrontstage2", 100, 20,
          IModelApp.i18n.translateWithNamespace("en","NineZoneSample:backstage.sampleFrontstage2"), undefined, "icon-placeholder"),
      ];
    }
