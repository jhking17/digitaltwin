...
export type graphMoveProps = {
    data?: any;
    storage?: any;
    id: number;
};

interface FinalGraphMoveProps extends graphMoveProps {}
export const GraphMove: React.FunctionComponent<FinalGraphMoveProps> = props => {
